...
print('Speed Limit Set at 20 Km-ph')
...
def trackMultipleObjects():
    ...
    while True:
        ...
        for carID in carTracker.keys():
            ...
            # ESTIMATE SPEED-----------------------------------------------------
            if carID not in startTracker and mark2 > ty + th > mark1 > ty:
                ...
                if speed > speedLimit:
                    print('CAR-ID : {} : {} km-ph - OVERSPEND'.format(carID, speed))
                    saveCar(image[ty:ty + th, tx:tx + tw])
                else:
                    print('CAR-ID : {} : {} km-ph'.format(carID, speed))
